...
#
# CÁCH DÙNG:
#   Đặt cùng thư mục conftest.py.
#   Trong conftest.py thêm:
#       from conftest_excel_report import ExcelReportPlugin
#       def pytest_configure(config):
#           ...
#           plugin = ExcelReportPlugin("Template_Test_Case_Bản1.xlsx")
#           config.pluginmanager.register(plugin, "excel_report_plugin")
#
